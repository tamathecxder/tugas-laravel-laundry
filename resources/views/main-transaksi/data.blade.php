                                    ...
                                    @foreach ($results as $data)
                                        <tr>
                                            ...
                                            <td class="d-flex flex-row text-sm">
                                                <a href="#" class="btn btn-info btn-sm" target="_blank">Download PDF</a> &nbsp;
                                                <a href="{{ route('main-transaksi.show', $data['kode_invoice']) }}" class="btn btn-success btn-sm" target="_blank">Test View PDF</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
